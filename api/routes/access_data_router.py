...
@project_router.get(
    "/getListProject", response_model=List[Project], tags=["Project Management"]
)
...
@project_router.put(
    "/updateProject", response_model=ProjectUpdateResponse, tags=["Project Management"]
)
...
@project_router.delete(
    "/deleteProject", response_model=ProjectDeleteResponse, tags=["Project Management"]
)
